        ...
        return (
            <View style={styles.mainBackdrop}>
                ...
                <ScrollView style={styles.mainScroll}>
                    ...
                    <InputBox name = 'Income Growth' placeholder='Growth %' stateKey = 'incomeGrowth' percent={true} iconName = 'attach-money' mask='only-numbers' precision={2} description={'hi'} _setState={this._setState.bind(this)} storageKey={T3IncomeGrowthKey} {...this.state}/>
                    ...
                    <InputBox name = 'Stocks' placeholder='Stocks %' stateKey = 'stocks' iconName ='home' mask='only-numbers' precision={0} description={'hi'} _setState={this._setState.bind(this)} storageKey={T3StockAllocKey} {...this.state}/>
                    <InputBox name = 'Bonds' placeholder='Bonds %' stateKey = 'bonds' iconName = 'attach-money' mask='only-numbers' precision={0} description={''} _setState={this._setState.bind(this)} storageKey={T3BondAllocKey} {...this.state}/>
                    <InputBox name = 'Cash' placeholder='Cash %' stateKey = 'cash' iconName = 'attach-money' mask='only-numbers' precision={0} description={'hi'} _setState={this._setState.bind(this)} storageKey={T3CashAllocKey} {...this.state}/>
                    <InputBoxHeader text = "Portfolio Returns"/>
                    <InputBox name = 'Stock Returns' placeholder='Returns %' stateKey = 'stockReturns' percent={true} iconName = 'credit-card' mask='only-numbers' precision={2} description={''} _setState={this._setState.bind(this)} storageKey={T3StockReturnKey} {...this.state}/>
                    <InputBox name = 'Bond Returns' placeholder='Returns %' stateKey = 'bondReturns' percent={true} iconName = 'trophy' mask='only-numbers' precision={2} iconType='font-awesome' description={''} _setState={this._setState.bind(this)} storageKey={T3BondReturnKey} {...this.state}/>
