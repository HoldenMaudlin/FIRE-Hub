    ...
    return(    
      <View style={styles.mainBackdrop}>
        ...
        <ScrollView style={styles.mainScroll}>                 
          <InputBox name = 'Amount' mask='money' stateKey = 'amount' iconName = 'attach-money' _setState={this._setState.bind(this)} storageKey = {T2AmountKey} description = 'Amount' {...this.state}/>
          <InputBoxHeader text='Current Investment' />
          <InputBox name = 'Returns' mask='only-numbers' stateKey = 'returns1' iconName = 'trending-up' _setState={this._setState.bind(this)} storageKey = {T2Inv1ReturnKey} description = 'Returns 1' {...this.state}/>
          <InputBox name = 'Fees' mask='only-numbers' stateKey = 'fees1' iconName = 'trending-down' _setState={this._setState.bind(this)} storageKey = {T2Inv1FeeKey} description = 'Fees 1' {...this.state}/>
          <InputBoxHeader text='Potential Investment' />
          <InputBox name = 'Returns' mask='only-numbers' stateKey = 'returns2' iconName = 'trending-up' _setState={this._setState.bind(this)} storageKey = {T2Inv2ReturnKey} description = 'Returns 2' {...this.state}/>
          <InputBox name = 'Fees' mask='only-numbers' stateKey = 'fees2' iconName = 'trending-down' _setState={this._setState.bind(this)} storageKey = {T2Inv2FeeKey} description = 'Fees 2' {...this.state}/>
          <InputBoxHeader text='Involuntary Contributions'/>
          <InputBox name = 'Expected Taxes' mask='only-numbers' stateKey = 'taxes' iconName = 'mood-bad' _setState={this._setState.bind(this)} storageKey = {T2TaxKey} description = 'Taxes' {...this.state}/>
